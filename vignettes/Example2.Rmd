...
Each day of a month has an unobserved ("latent") weather state ($W_i \in ${\🌧️, ☁️, ☀️ }). We assume each weather is equally likely to happen on each day. 
For each weather condition, we have a different distribution of Negroni sales each day $Y_i$ which we assume follows:
